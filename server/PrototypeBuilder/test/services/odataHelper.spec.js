...
describe('OData Helper', function () {
    ...
    describe('can parse vocabularies', function () {
        xit('and return proper type and terms', function () {
        ...
        xit('and can recognize some parameters', function () {
    ...
    describe('can avoid conflicts', function () {
        ...
        it('when property names do not exist', function () {
            var newPropertyName = oDataHelper.createExtraProperty('Entity_0', 'OKName'); // does not exist
            expect(newPropertyName === 'OKName').to.be.true;
        });

        it('when property names exist', function () {
            var newPropertyName = oDataHelper.createExtraProperty('Entity_0', 'ID'); // 'ID' exists
            expect(newPropertyName === 'ID_1').to.be.true;
        });

        it('when property names exist twice', function () {
            var newPropertyName = oDataHelper.createExtraProperty('Entity_1', 'Name'); // 'Name' & 'Name_1' exists
