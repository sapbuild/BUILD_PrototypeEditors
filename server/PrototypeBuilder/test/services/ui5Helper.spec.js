...
describe('UI5 Helper', function () {
    ...
    describe('can generate index html', function () {
        ...
        it('for simple page', function () {
            ...
            expect(viewHelper.generateIndex([pageMetadata], '/sapui5/resources')).to.equal(sampleIndex);
        });
        it('for simple page in snapshot', function () {
            ...
            expect(viewHelper.generateIndex([pageMetadata], '/sapui5/resources', true)).to.equal(sampleIndex);
        });
    });
    ...
    describe('can generate router', function () {
        ...
        var pageMetadata =
            {
                "name":"SimplePage",
                "displayName":"Page 1",
                "routePattern":"SimplePage",
                "pageUrl":"index.html#/S0",
                "thumbnailUrl":"resources/thumbnail/S0.png",
                "id":"8d9dc216cd580dfd0a344182",
                "_id":"55716e61bdcf02840e7fd4cf",
                "coordinates":{
                    "y":-1,
                    "x":-1
                }
        ...
        it('for simple page', function () {
            ...
            expect(viewHelper.generateRouter().replace(/\r\n/g, '\n').replace(/\t/g, '    ')).to.equal(sampleRouter);
        });
    });
    ...
    describe('can generate ComponentPreload bundle', function () {
        it('for simple xml view', function () {
            ...
            var expBundle = 'jQuery.sap.registerPreloadedModules({\n' +
                ...
                '});';
            expect(bundleContent.replace(/\r\n/g, '\n').replace(/\t/g, '    ')).to.equal(expBundle);
        });
