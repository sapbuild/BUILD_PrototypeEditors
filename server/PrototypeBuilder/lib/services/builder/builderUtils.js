...
var versionLessAssetUrlRegexp = /\/api\/projects\/[a-f0-9]{24}\/document\/([a-f0-9]{24})/i;
...
exports.getEntityById = function (entityId) {
    var entityMatch;
    if (entityId && this.dataModel) {
...
exports.replaceAssetUrl = function (assetUrl, assetsToCopy) {
    ...
    if (assetsToCopy !== null) {
        ...
        if (assetUrlMatches !== null) {
            ...
            // Fix Beta 3, in some case the version isn't filed in
            assetUrlMatches = versionLessAssetUrlRegexp.exec(assetUrl);
            if (assetUrlMatches !== null) {
                assetData = {
                    workspacePath: ASSET_BASE_PATH + assetUrlMatches[1],
                    id: assetUrlMatches[1],
