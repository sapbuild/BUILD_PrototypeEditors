...
exports.generateEDMX = function (prototypeDataModel) {
    ...
    _.each(dataModelExtension, function (newEntity, entityName) {
        ...
        if (!entityToModify) {
            ...
            entityToModify = {
                ...
                properties: [
                    {name: 'ID', isKey: true, propertyType: 'String'}
                ],
        ...
        _.each(newEntity, function (propertyValue, propertyName) {
            if (propertyValue.isNavProp) {
                ...
                if (!existingProperty) {
                    // by default a property is nullable (= non mandatory)
                    var bNullable = propertyValue.nullable !== undefined ? propertyValue.nullable : true;
                    ...
                    if (propertyValue.nullable) {
                        existingProperty.Nullable = propertyValue.nullable;
                    }
                }
    ...
    prototypeDataModel.entities.forEach(function (entity) {
        var entityContainerType = entityContainer.ele('EntitySet', {
            Name: entity.nameSet,
        ...
        if (entity.isReadOnly !== undefined) {
            entityContainerType.att('sap:creatable', !entity.isReadOnly);
            entityContainerType.att('sap:updatable', !entity.isReadOnly);
            entityContainerType.att('sap:deletable', !entity.isReadOnly);
        }
        ...
        entity.properties.forEach(function (property) {
                ...
                if (property.Nullable !== undefined) {
                    propAttributes.Nullable = property.Nullable;
                }
                if (property.isReadOnly !== undefined) {
                    propAttributes['sap:creatable'] = !property.isReadOnly;
                    propAttributes['sap:updatable'] = !property.isReadOnly;
                    propAttributes['sap:deletable'] = !property.isReadOnly;
                }
...
function generateData(entity, keyIdx) {
    var data = {};
...
exports.getEntityData = function (projectId, entity, sampleDataMetadata, assets, assetsToCopy) {
    ...
    if (sampleDataEntity && !_.isEmpty(sampleDataEntity.properties)) {
            ...
            if (property.isAsset) {
                _.each(entityData, function (line) {
                    ...
                    if (associatedAsset) {
                        ...
                        var baseAssetUrl = '/api/projects/' + projectId + '/document/' + assetId + '/1';
                        var targetUrl = builderUtils.replaceAssetUrl(baseAssetUrl, assetsToCopy);
                        if (baseAssetUrl === targetUrl) {
                            targetUrl += '/render';
                        }
                        line[property.name] = targetUrl;
                    }
                    else {
        ...
        entityData = [];
        for (var i = 0; i < 10; i++) {
            entityData.push(generateData(entity, i));
        }
    }
