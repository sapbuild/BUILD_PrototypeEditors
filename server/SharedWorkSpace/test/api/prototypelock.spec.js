(function () {
    ...
    describe('PrototypeLock API Test', function () {
        ...
        it('prototypeLock.api keepAlive', function (done) {
            Promise.resolve(prototypeLockService.updatePrototypeLock(mockRequest, mockResponse))
                .then(function () {
                    expect(mockResponse.jsonVal).to.be.equal(successData);
                    expect(mockResponse.statusCode).to.be.equal(200);
                    done();
        ...
        it('prototypeLock.api keepAlive - failed to update time', function (done) {
            Promise.resolve(prototypeLockService.updatePrototypeLock(mockFailureRequest, mockResponse))
                .then(function () {
                    expect(mockResponse.jsonVal).to.be.equal(generalError);
                    expect(mockResponse.statusCode).to.be.equal(500);
                    done();
