...
(function () {
    ...
    var UICatalogMock = {
        ...
        getCatalogsByIds: function () {
            return Promise.resolve(new Array(catalogMock));
        }
    };
    ...
    describe('PageMetadataService', function () {
        ...
        describe('pageMetadata Service Check', function () {
            ...
            it('createApp: with args number of pages', function (done) {
                ...
                var projectId = '0397820d2eccf02f0999a075';

                pageMetadataService.createApp(projectId, "App").then(
                    function (result) {
                        // two pages is expected to be created
                        expect(result.pagesMetadata.length).to.be.equal(0);
            ...
            it('createApp with args: empty data driven pageflow', function (done) {
                ...
                pageMetadataService.createApp(projectId, stats, 'masterDetail').then(
                    function (result) {
            ...
            xit('createApp: full data driven pageflow', function (done) {
            ...
            it('createPage with args: floorplan names and update AppMetadata', function (done) {
                ...
                var mockReq = {};
                mockReq['body'] = {};
                mockReq.body['pageArray'] = [{
                    floorPlan: 'ABSOLUTE',
                    catalogId: catalogId
                }];

                pageMetadataService.createPage(projectId, mockReq, stats).then(
                    function (result) {
                        logger.info('checking the result with MockedData of createdPage.');
            ...
            xit('createPage: full data driven pageflow', function (done) {
                ...
                pageMetadataService.createPages(projectId, stats, 'masterDetail').then(
                    function (result) {
                        logger.info('checking the result with MockedData of createdPage.');
                        ...
                        // should have pagesMetadata
                        expect(result.pagesMetadata.length).not.to.be.equal(0);
                        // should have thumbnails generated
                        expect(Object.keys(result.thumbnails).length).to.be.equal(result.pagesMetadata.length);
