...
module.exports = ['$rootScope', '$scope', '$state', '$stateParams', 'dm.ModelEditorService', 'AsideFactory', 'dm.SidePanelService', HeaderBarController];
