 ...
 * @property {boolean} showDrop - Indicates if this node will accept a drop bellow him
    ...
    function (npUiCatalog, uiUtil, npGrid, npPageMetadata) {
        ...
        var factories = {
            ...
            gridElement: function (options, parent, parentIndex) {
                ...
                if (controlMd.designProperties && _.result(_.find(controlMd.designProperties, 'name', 'isUndeletable'), 'value')) {
                    options.isUndeletable = true;
                }
                else {
                    options.isUndeletable = npUiCatalog.isUndeletable(controlMd.catalogControlName, controlMd.catalogId);
                }
                var node = factories.node(options, parent, parentIndex);
                node.select = function () {
