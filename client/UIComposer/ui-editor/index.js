...
module.exports = angular.module('uiComposer.uiEditor', [
    ...
    .directive('npCssTransitionEndHandler', require('./directives/np-csstransition-end-handler/np-csstransition-end-handler.directive.js'))
...
uiEditorConfig.$inject = ['$stateProvider'];
