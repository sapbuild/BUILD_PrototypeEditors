...
var npPageMetadataCloneControl = ['npPageMetadataHelper', 'npPageMetadataAddControl', 'npLayoutHelper', 'npConstants', 'npControlMetadataPrototype',
    function (pageMdHelper, addControlService, npLayoutHelper, npConstants, controlMdPrototype) {
        ...
        var cloneControls = function (controlDefs, targetPageMd) {
            ...
            _.forEach(controlDefs, function (controlDef) {
                ...
                _.forEach(clonesMd, function (cloneMd) {
                    ...
                    controlMdPrototype.setControlMdPrototype(cloneMd, targetPageMd);
                    clones.push(cloneMd);
                });
