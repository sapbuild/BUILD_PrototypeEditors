...
var npPageMetadataAddControl = ['$q', '$log', 'npPageMetadataHelper', 'npPageMetadataEvents', 'npUiCatalog', 'npLayoutHelper', 'uiUtil', 'npControlMetadataPrototype',
    function ($q, $log, pageMdHelper, pageMdEvents, npUiCatalog, npLayoutHelper, uiUtil, controlMdPrototype) {
         ...
         */
        var createFloorplanProperties = function (x, y) {
        ...
        var createControlMdObject = function (controlDef) {
            ...
            controlMd.floorplanProperties = createFloorplanProperties(controlDef.x, controlDef.y);
            ...
            setDefaultPropertyValues(controlMd.designProperties, controlDef.defaultDesignPropertyValues);
            return controlMd;
        };
            ...
            _.forEach(catalogAggregations, function (aggregation) {
                _.forEach(aggregation.defaultValue, function (defaultValue) {
                    var childrenMd = getControlMdObjects({
                        ...
                        defaultDesignPropertyValues: defaultValue.designProperties
                    }, pageMd);
        ...
        var addControlToPage = function (controlMd, pageMd) {
            ...
            controlMdPrototype.setControlMdPrototype(controlMd, pageMd);
        ...
        return {
            getNextId: getNextId,
            createFloorplanProperties: createFloorplanProperties,
