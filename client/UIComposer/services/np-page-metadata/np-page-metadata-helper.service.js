    ...
    function ($q, $log, npUiCatalog) {
        ...
        var getControlAndChildMd = function (controlId, pageMd) {
            ...
            _.forEach(controlMd.groups, function (groupMd) {
                _.forEach(groupMd.children, function (childId) {
                    childrenMd = childrenMd.concat(getControlAndChildMd(childId, pageMd));
                });
            });
         ...
         * @param {string[]} controlIds
         * @param {object} pageMd
         * @returns {ControlMd[]} Array of control md objects in parent-child order (control1, control1-child1, control1-child2, control1-child2-child1, control-2...)
         */
        var getControlsAndChildMd = function (controlIds, pageMd) {
            var result = [];
            _.forEach(controlIds, function (controlId) {
                result = result.concat(getControlAndChildMd(controlId, pageMd));
            });
            return _.uniq(result, 'controlId');
        };
        ...
        /**
         * @name getControlFloorplanProperty
         * @memberof uiComposer:services:npPageMetadataHelper
         * @param {string} floorplanPropertyName
         * @param {Object} controlMd
         * @returns {DesignPropertyMd} The floorplan property metadata for a certain property.
         */
        var getControlFloorplanProperty = function (floorplanPropertyName, controlMd) {
            return _.find(controlMd.floorplanProperties, {name: floorplanPropertyName});
        };
        ...
        return {
            ...
            getControlFloorplanProperty: getControlFloorplanProperty,
