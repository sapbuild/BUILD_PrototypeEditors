...
var npPageMetadataMoveControl = ['npPageMetadataHelper', 'npPageMetadataEvents', 'npPageMetadataAddControl', 'npPageMetadataDeleteControl',
    function (pageMdHelper, pageMdEvents, addControlService, deleteControlService) {
        ...
        /**
         * @name createMoveDefinition
         * @memberof uiComposer:services:npPageMetadata:moveControl
         * @description
         * Create a move definition from a control metadata object by extracting all information necessary for performing a move.
         *
         * @param {ControlMd} controlMd
         * @returns {MoveDefinition}
         */
        var createMoveDefinition = function (controlMd) {
            return {
                ...
                x: (pageMdHelper.getControlFloorplanProperty('left', controlMd) || {}).value,
                y: (pageMdHelper.getControlFloorplanProperty('top', controlMd) || {}).value
            };
        };
        ...
        var performMove = function (controlDef, pageMd) {
            ...
            controlMd.floorplanProperties = addControlService.createFloorplanProperties(_.parseInt(controlDef.x), _.parseInt(controlDef.y));
        ...
        return {
            createMoveDefinition: createMoveDefinition,
