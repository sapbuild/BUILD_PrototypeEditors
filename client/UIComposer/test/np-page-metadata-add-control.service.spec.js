...
(function () {
    ...
    describe('Service: np-page-metadata-add-control', function () {
        var npPageMetadataAddControl, npPageMetadataHelperMock,
            npLayoutHelperMock, npUiCatalogMock, npPageMetadataEventsMock, pageMetadataMock, uiUtilMock, npControlMetadataPrototypeMock;
        ...
        beforeEach(function () {
            ...
            npControlMetadataPrototypeMock = {
            ...
            module(function ($provide) {
                ...
                $provide.value('npControlMetadataPrototype', npControlMetadataPrototypeMock);
            });
        ...
        it('Should get Floor plan properties in Md format', function () {
            var floorPlanProps = npPageMetadataAddControl.createFloorplanProperties(50, 60);
