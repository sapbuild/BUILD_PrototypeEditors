...
(function () {
    ...
    describe('Controller: ui-editor', function () {
        var disablePrototypeGeneration, featureToggleMock, createController, scope, $httpBackend, $rootScope, npFormFactor, npPrototypeMock, $q, npPageMetadataMock,
            ...
            resPrototypeLockMock, uiCommandManagerMock, npLayoutHelperMock, npPageMetadataEventsMock, resPrototypeMock, uiWebAnalyticsMock;
        ...
        resPrototypeLockMock = {success: true};
        ...
        beforeEach(inject(function ($injector, $controller) {
            ...
            createController = function () {
                ...
                return $controller('UiEditorCtrl', {
                    ...
                    resPrototypeLock: resPrototypeLockMock,
                    ...
                    uiWebAnalytics: uiWebAnalyticsMock
                });
            };
        }));
