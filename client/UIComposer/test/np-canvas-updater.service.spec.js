    ...
    describe('Service: np-canvas-updater:', function () {
        ...
        beforeEach(function () {
            npUiCanvasAPIMock = {
                ...
                bindControlGroup: sinon.stub(),
                unbindControlGroup: sinon.stub(),
        ...
        describe('changing bindings:', function () {
            ...
            it('should navigate to the appropriate page before changing bindings', function () {
                canvasUpdater.startListeningForMetadataChanges();
                var navSpy = sinon.spy(npUiCanvasAPIMock, 'navTo'),
                    evt = {},
                    pageMd = {},
                    bindingDef = {
                        controlMd: createControlMdObj('list'),
                        groupMd: {}
                    };
                npPageMetadataEventsMock._trigger('controlsBindingChanged', [evt, pageMd, [bindingDef]]);
                $rootScope.$apply();
                expect(navSpy.calledWith(pageMd)).to.be.ok;
                expect(npUiCanvasAPIMock.bindControlGroup.calledAfter(navSpy)).to.be.ok;
            });

            it('should bind the control group', function () {
                canvasUpdater.startListeningForMetadataChanges();
                var evt = {},
                    pageMd = {},
                    bindingDef = {
                ...
                npPageMetadataEventsMock._trigger('controlsBindingChanged', [evt, pageMd, [bindingDef]]);
                $rootScope.$apply();
                expect(npUiCanvasAPIMock.bindControlGroup.calledWith(bindingDef.controlMd, bindingDef.groupMd)).to.be.ok;
                expect(npUiCanvasAPIMock.unbindControlGroup.called).to.be.false;
            });
            it('should unbind the control group', function () {
                canvasUpdater.startListeningForMetadataChanges();
                var evt = {},
                    pageMd = {},
                    bindingDef = {
                ...
                npPageMetadataEventsMock._trigger('controlsBindingChanged', [evt, pageMd, [bindingDef]]);
                $rootScope.$apply();
                expect(npUiCanvasAPIMock.unbindControlGroup.calledWith(bindingDef.controlMd, bindingDef.groupMd)).to.be.ok;
            });
        });
    });
})();
