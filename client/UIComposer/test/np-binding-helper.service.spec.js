...
(function () {
    ...
    describe('Service: np-binding-helper', function () {
        ...
        npUiCatalogMock = {
            ...
            isDataDrivenAggregation: function () {
                return true;
            }
        };
        ...
        it('Get possible paths for a group', function () {
            ...
            var ctrlMd = {catalogControlName: 'ctrl1', catalogId: 'catalog1'};
            ...
            var result = npBindingHelper.getGroupPathsFromMd(ctrlGroupMd, ctrlMd);
        ...
        it('Get possible paths for a property under a group that have a context property that is not bound (smart template only)', function () {
            npBindingHelper.initEntities('model2');
            var controlMdForContextProperty = {
                parentGroup: {
                    groupId: 'contextProperty',
            ...
            // As the context property has not binding, we should have no possible values
            var contextPropertyPossiblePaths = undefined;
            var result = npBindingHelper.getPropertyPathsFromMd(ctrlProperty, controlMdForContextProperty, 'entity1Id');
            expect(result).to.deep.equal(contextPropertyPossiblePaths);
        });
