...
(function () {
    ...
    describe('Service: np-tree-node-factory', function () {
        ...
        describe('gridElement nodes:', function () {
            ...
            it('should read the control\'s isUndeletable property from the catalog and set it on the node', function () {
                npUiCatalogMock.isUndeletable = function () {
                    return true;
                };
                var gridElement = {
                        controlMd: {},
                ...
                expect(node.isUndeletable).to.be.true;
            });
