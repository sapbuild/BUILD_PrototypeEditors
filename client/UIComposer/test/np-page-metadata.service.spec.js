...
(function () {
    ...
    describe('Service: np-page-metadata', function () {
        var $rootScope, $httpBackend, $q, npPageMetadata, $locationMock, npPrototypeMock,
            ActiveProjectServiceMock, npUiCanvasAPIMock, npUiCatalogMock,
            npPageMetadataAddControlMock, npPageMetadataDeleteControlMock, npPageMetadataMoveControlMock, npPageMetadataChangePropertyMock,
            npPageMetadataControlBindingMock, npPageMetadataHelperMock,
            npLayoutHelperMock, npAbsoluteLayoutHelperMock, npPageMetadataEventsMock, uiCommandManagerMock, stateMock, npConstantsMock, uiErrorMock,
            npImageHelperMock, npPageMetadataPersistMock;
        ...
        beforeEach(function () {
            ...
            npPageMetadataMoveControlMock = {
                ...
                createMoveDefinition: sinon.stub()
            };
            ...
            npPageMetadataPersistMock = {
                updatePage: sinon.stub(),
                flushUpdates: sinon.stub()
            };
            ...
            module(function ($provide) {
                ...
                $provide.value('npPageMetadataPersist', npPageMetadataPersistMock);
            });
            ...
            inject(function ($injector) {
                ...
                $httpBackend.whenPUT('/api/projects/Project123/prototype/page').respond({
                    status: 'OK'
                });
            });
        });
