        ...
        return {
            ...
            link: function (scope) {
                ...
                function onAfterEnter() {
                    kl1 = npKeyboarder.on(npConstants.keymap.Escape, onEscape);
                    kl2 = npKeyboarder.on(npConstants.keymap.Enter, onEnter);
                }

                scope.$on('page-map-view/afterEnter', onAfterEnter);
                scope.$on('page-map-view/beforeExit', onBeforeExit);
            }
        };
    }
];
